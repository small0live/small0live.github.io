...
subtitle: Current and Past Contributions
---
...
* Summary: This project aims to understand (1) how decrements in individual cognition will alter team cognition and (2) how unobtrusive measures can be leveraged to monitor team functioning. 
...
* Summary: This projects aims to contribute to the science of team science through an investigation of collaborative learning requirements for teams engaged in interdisciplinary research. This includes the conceptualization of individual competencies for effective team science and the refinement of team learning measurement for interdisciplinary science teams. 
    * <a href="{{ '/network.html' | prepend: site.baseurl }}">View an interactive network visualization I made based on the semantic similarity of team learning measure items.</a>
...
* Summary: This projects aims to inform the development of strategies for inclusivity and diversity in software development to increase equity in tech innovation. I draw from systems theory to conceptualize leverage points for change, focusing on system intent (the goals, mindsets, paradigms of individuals and collectives) and system design (the structure of information flows, e.g., in social computing technologies).
* Publications and Presentations: GE@ICSE 2023, INFORMS 2023


## Past

**Artificial Social Intelligence for Successful Teams** (2019 - 2020)
<br>
